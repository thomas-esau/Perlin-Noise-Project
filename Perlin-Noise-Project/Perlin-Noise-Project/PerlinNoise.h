...
public:
	...
	inline double lerp(double lo, double hi, double w);
	inline double dotProduct(double xi, double yi, double x, double y);
	double* calcUnitVector(double angle);
	inline double smoothstep(double num);
	double noise(double x, double y);

	// Output Functions
	void createFile(std::string filename, std::string filetype, PerlinParameters params);
